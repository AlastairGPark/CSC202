...
from CircQ import CircQ

class TestCircQ(unittest.TestCase):
    def setUp(self) -> None:
        self._empty: CircQ[int] = CircQ[int]() # type: ignore

        self._1item: CircQ[int] = CircQ[int]() # type: ignore
        self._1item.push(5)

        self._3items: CircQ[str] = CircQ[str]() # type: ignore

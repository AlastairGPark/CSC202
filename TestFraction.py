...
class TestFraction(unittest.TestCase):
    ...
    def test_sub_doubles(self) -> None:
        self.assertTrue(Fraction(1, 4) ==
    ...
    def test_truediv_exact(self) -> None:
        self.assertAlmostEqual(0.5, Fraction(1, 4) / Fraction(2, 4))

    def test_truediv_close(self) -> None:
        self.assertAlmostEqual(1.07692, Fraction(7, 8) / Fraction(13, 16), 5)

    def test_gt_true(self) -> None:
        self.assertTrue(Fraction(3, 4) ==
    ...
    def test_ge_equal(self) -> None:
        self.assertTrue(Fraction(2, 4) ==
            Fraction(2, 4) >= Fraction(2, 4))

    def test_ge_inequal_True(self) -> None:
        self.assertTrue(Fraction(3, 4) ==
            Fraction(3, 4) >= Fraction(2, 4))

    def test_ge_inequal_False(self) -> None:
        self.assertTrue(Fraction(1, 2) >= Fraction(2, 4))
    ...
    def test_le_inequal_True(self) -> None:
        self.assertTrue(Fraction(1, 2) ==
            Fraction(2, 4) <= Fraction(1, 2))

    def test_le_inequal_False(self) -> None:
